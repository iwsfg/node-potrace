 ...
 * @property {Number}  [threshold]   - threshold below which color is considered black (0..255, default 128)
 * @property {Boolean} [whiteOnBlack] - specifies colors by which side from threshold should be traced (default false)
 */