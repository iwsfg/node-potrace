 ...
 *
 * @param {*} file Source image or file path
 * @param {Potrace~Options} [options]
 * @param {Function} cb Callback function. Accepts 3 arguments: error, svg content and instance of {@link Potrace} (so it could be reused with different set of parameters)
 */
